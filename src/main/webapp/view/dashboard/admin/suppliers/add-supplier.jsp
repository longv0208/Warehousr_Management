<%-- 
    ...
    Created on : Jun 11, 2025, 9:16:54 PM
    Author     : FPTSHOP
--%>
...
<head>
  ...
  <title>Thêm Nhà Cung Cấp - Quản Lý Kho Hàng</title>
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4 py-4">
      ...
      <form action="${pageContext.request.contextPath}/admin/manage-supplier" method="POST" id="supplierForm" novalidate>
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="contactPerson" name="contactPerson" maxlength="100" required>
            <div class="invalid-feedback"></div>
            <div class="form-text">Tối đa 100 ký tự</div>
          </div>
        </div>
