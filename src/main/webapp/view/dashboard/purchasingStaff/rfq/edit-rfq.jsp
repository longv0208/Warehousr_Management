...
<head>
    ...
    <title>Edit Request for Quotation</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">Edit Request for Quotation - ${rfq.rfqCode}</h4>
                            <div class="d-flex gap-2">
                                <a href="purchasing?action=view-rfq&id=${rfq.rfqId}" class="btn btn-info">
                                    <i class="fas fa-eye"></i> View RFQ
                                </a>
                        ...
                        <div class="card-body">
                            <form action="purchasing" method="post" id="rfqForm">
                                <input type="hidden" name="action" value="update-rfq">
                                <input type="hidden" name="rfqId" value="${rfq.rfqId}">
                                
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="providerId" class="form-label">Supplier <span class="text-danger">*</span></label>
                                            <select class="form-select" id="providerId" name="providerId" required>
                                                <option value="">Select Supplier</option>
                                                <c:forEach var="supplier" items="${suppliers}">
                                                    <option value="${supplier.supplierId}" 
                                                            ${supplier.supplierId == rfq.providerId ? 'selected' : ''}>
                                            ...
                                            <select class="form-select" id="warehouseId" name="warehouseId" required>
                                                ...
                                                <c:forEach var="warehouse" items="${warehouses}">
                                                    <option value="${warehouse.warehouseId}" 
                                                            ${warehouse.warehouseId == rfq.warehouseId ? 'selected' : ''}>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="expectedDeliveryDate" class="form-label">Expected Delivery Date <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control" id="expectedDeliveryDate" name="expectedDeliveryDate" 
                                                   value="<fmt:formatDate value='${rfq.expectedDeliveryDate}' pattern='yyyy-MM-dd'/>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="note" class="form-label">Note</label>
                                            <textarea class="form-control" id="note" name="note" rows="3">${rfq.note}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="productTable">
                                        ...
                                        <tbody id="productTableBody">
                                            <c:choose>
                                                <c:when test="${not empty rfqDetails}">
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to update this RFQ?')">
                                        <i class="fas fa-save"></i> Update RFQ
                                    </button>
                                </div>
                            </form>
                        </div>
