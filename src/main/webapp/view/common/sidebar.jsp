    ...
    <%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ page import="model.User" %>
            <%@ page import="utils.SessionUtil" %>
                <% User currentUser=SessionUtil.getUserFromSession(request); String userRole=(currentUser !=null) ?
                    ...
                    <nav class="sidebar" id="sidebar">
                        <div class="user-section" id="userSection">
                            <div class="user-avatar-wrapper" style="position: relative; display: inline-block;">
                                <i class="bi bi-person-circle user-avatar-icon" id="userAvatar"></i>
                                <div class="user-name">
                            ...
                            <% if ("admin".equals(userRole)) { %>
                                <li class="nav-item">
                                    <a href="${pageContext.request.contextPath}/dashboard" class="nav-link"><i
                                            class="bi bi-people"></i><span class="link-text">Dashboard</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="${pageContext.request.contextPath}/admin/manage-user" class="nav-link"><i
                                            class="bi bi-people"></i><span class="link-text">Người dùng</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="${pageContext.request.contextPath}/admin/manage-notification"
                                        class="nav-link"><i class="bi bi-bell"></i><span class="link-text">Thông
                                            báo</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="collapse" href="#activityCollapse" role="button"
                                        aria-expanded="false" aria-controls="activityCollapse">
                                        <i class="bi bi-shield-check"></i><span class="link-text">Giám sát hoạt
                                            động</span>
                                    </a>
                                    ...
                                    <% if ("warehouse_manager".equals(userRole)) { %>
                                        ...
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/admin/manage-category"
                                                class="nav-link"><i class="bi bi-tags"></i><span class="link-text">Danh
                                                    mục</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/admin/manage-product"
                                                class="nav-link"><i class="bi bi-box-seam"></i><span
                                                    class="link-text">Sản phẩm</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/admin/manage-supplier"
                                                class="nav-link"><i class="bi bi-truck"></i><span class="link-text">Nhà
                                                    cung cấp</span></a>
                                        </li>
                                        <!--        <li class="nav-item">
                    <a href="${pageContext.request.contextPath}/admin/manage-sales-order" class="nav-link"><i class="bi bi-receipt"></i><span class="link-text">Đơn bán hàng</span></a>
                                        ...
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/stock-take" class="nav-link"><i
                                                    class="bi bi-clipboard-check"></i><span class="link-text">Kiểm kê
                                                    kho</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/low-stock-report"
                                                class="nav-link">
                                                <i class="bi bi-exclamation-triangle"></i><span class="link-text">Hàng
                                                    sắp hết</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="${pageContext.request.contextPath}/admin/manage-warehouse"
                                                class="nav-link"><i class="bi bi-building"></i><span
                                                    class="link-text">Kho hàng</span></a>
                                        </li>
                                        <% } %>
                                            ...
                                            <% if (!"admin".equals(userRole)) { %>
                                                <li class="nav-item">
                                                    <a href="${pageContext.request.contextPath}/notifications"
                                                        class="nav-link">
                                                        <i class="bi bi-bell-fill"></i><span class="link-text">Thông báo
                                                            của bạn</span>
                                                    </a>
                                                </li>
                                                <% } %>
                                                    ...
                                                    <% if ("purchasing_staff".equals(userRole)) { %>
                                                        <li class="nav-item">
                                                            <a href="${pageContext.request.contextPath}/purchasing?action=inventory-list"
                                                                class="nav-link"><i class="bi bi-boxes"></i><span
                                                                    class="link-text">Xem tồn kho</span></a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="${pageContext.request.contextPath}/purchasing?action=list-rfq"
                                                                class="nav-link"><i class="bi bi-file-text"></i><span
                                                                    class="link-text">Quản lý RFQ</span></a>
                                                        </li>
                                                        <% } %>
                                                                ...
                                                                <li class="nav-item">
                                                                    <a href="${pageContext.request.contextPath}/sale-staff/sales-order"
                                                                        class="nav-link"><i
                                                                            ...
                                                                            class="link-text">Đơn bán hàng</span></a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a href="${pageContext.request.contextPath}/warehouse-manager/delivery?action=list"
                                                                        class="nav-link"><i
                                                                            class="bi bi-geo-alt"></i><span
                                                                            class="link-text">Theo dõi giao
                                                                            hàng</span></a>
                                                                </li>
                                                                <% } %>
                                                                    ...
                                                                    <% if ("warehouse_staff".equals(userRole)) { %>
                                                                        <li class="nav-item">
                                                                            <a href="${pageContext.request.contextPath}/warehouse?action=list-po-for-inward"
                                                                                class="nav-link"><i
                                                                                    class="bi bi-box-arrow-in-down"></i><span
                                                                                    class="link-text">Nhận
                                                                                    hàng</span></a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                            <a href="${pageContext.request.contextPath}/warehouse?action=list-sales-orders"
                                                                                class="nav-link"><i
                                                                                    class="bi bi-box-arrow-up"></i><span
                                                                                    class="link-text">Xuất kho bán
                                                                                    hàng</span></a>
                                                                        </li>
                                                                        <li class="nav-item">
                                                                        ...
                                                                        <% } %>
                                                                            ...
                                                                            <% if ("warehouse_staff".equals(userRole)
                                                                                ...
                                                                                .equals(userRole)) { %>
                                                                                <li class="nav-item">
                                                                                    <a href="${pageContext.request.contextPath}/warehouse?action=list-stock-inward"
                                                                                        class="nav-link"><i
                                                                                            class="bi bi-card-list"></i><span
                                                                                            class="link-text">DS Phiếu
                                                                                            Nhập Kho</span></a>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    <a href="${pageContext.request.contextPath}/warehouse?action=list-outwards"
                                                                                        class="nav-link"><i
                                                                                            class="bi bi-card-list"></i><span
                                                                                            class="link-text">DS Phiếu
                                                                                            Xuất Kho</span></a>
