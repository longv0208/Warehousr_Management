...
@WebServlet(name = "WarehouseManagementController", urlPatterns = {"/warehouse-manager/manage-warehouse"})
public class WarehouseManagementController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!"warehouse_manager".equals(currentUser.getRoleId())) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String action = request.getParameter("action");
        if (action == null) {
            response.sendRedirect(request.getContextPath() + "/warehouse-manager/manage-warehouse?action=list");
            return;
        }
    ...
    private void listWarehouses(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/view/dashboard/warehouseManager/warehouse/warehouse.jsp").forward(request, response);
    }

    private void showCreateForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/view/dashboard/warehouseManager/warehouse/addWarehouse.jsp").forward(request, response);
    }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("/view/dashboard/warehouseManager/warehouse/edit-warehouse.jsp").forward(request, response);
    ...
    private void viewWarehouse(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("/view/dashboard/warehouseManager/warehouse/view-warehouse.jsp").forward(request, response);
        } catch (NumberFormatException e) {
            response.sendRedirect(request.getContextPath() + "/warehouse-manager/manage-warehouse?action=list");
        }
    }
